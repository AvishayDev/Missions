...
import { MissionSelector, openMissionChildren, removeMission } from "../redux/features/MissionsSlice";
...
const Mission:React.FC<MissionProps> = ({id}:MissionProps) => {
    ...
    return (
        ...
        <View style={globalStyles.rowContainer}>
            ...
            {mission.children.length > 0 && <Button title="open" onPress={()=>dispatch(openMissionChildren(id))}/>}
        </View>
